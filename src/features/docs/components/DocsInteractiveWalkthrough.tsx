...
export const DocsInteractiveWalkthrough: React.FC<DocsInteractiveWalkthroughProps> = ({ scenario }) => {
  ...
  return (
    <div className="my-8 border border-primary/20 bg-card rounded-xl overflow-hidden shadow-sm">
      <div className="bg-primary/5 p-4 border-b border-primary/20">
        ...
        <p className="text-sm text-muted-foreground mt-1">Try it yourself in this safe, simulated environment.</p>
      </div>
