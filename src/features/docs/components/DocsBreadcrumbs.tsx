...
export const DocsBreadcrumbs = () => {
  ...
  return (
    <nav
      ...
      className="mb-6 flex flex-wrap items-center gap-y-2 text-sm text-muted-foreground min-w-0 w-full overflow-hidden"
    >
      <Link
        href="/docs"
        className="hover:text-foreground transition-colors flex items-center shrink-0"
      >
