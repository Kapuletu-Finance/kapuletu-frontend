                          ...
                          <div className="p-4 grid grid-cols-2 gap-4">
                            <div className="space-y-2">
                              <h4 className="text-sm font-semibold text-destructive flex items-center gap-2">
                                <IconLibrary name="close" className="h-4 w-4" /> Original Parsed
                                Data
                              </h4>
                              <ScrollArea
                                orientation="horizontal"
                                className="w-full bg-destructive/5 border border-destructive/10 rounded-md"
                              >
                            ...
                            <div className="space-y-2">
                              ...
                              <ScrollArea
                                orientation="horizontal"
                                className="w-full bg-emerald-500/5 border border-emerald-500/10 rounded-md"
                              >
