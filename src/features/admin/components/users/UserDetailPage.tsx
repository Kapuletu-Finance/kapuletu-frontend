...
import { useTriggerPasswordResetMutation } from "@/features/admin/services/mutations";
import {
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="flex flex-col gap-1">
            ...
            <p className="text-sm text-muted-foreground">Identifier: {userDetails.profile.slug}</p>
          </div>
          <div className="flex items-center gap-2">
            ...
            >
              <IconLibrary name="key" className="mr-2 size-4" />
