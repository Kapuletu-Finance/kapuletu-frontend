...
export default function ContributionsIndexPage() {
  const recordingGuides = [
    ...
    {
      title: "Recording M-Pesa, cash, and bank contributions",
      link: "/docs/contributions/recording-types",
    },
    {
      title: "Recording a pledge & partial payments",
      link: "/docs/contributions/recording-pledges",
    },
  ];
  ...
  const inboxGuides = [
    ...
    {
      title: "Opening a contribution & Reviewing details",
      link: "/docs/contributions/reviewing-details",
    },
    { title: "Checking contributor information", link: "/docs/contributions/checking-contributor" },
    {
      title: "Correcting information (Editing amount, changing activity)",
      link: "/docs/contributions/correcting-info",
    },
  ...
  return (
    ...
    >
      <DocsCallout type="warning" title="Important">
        Remember that contributions must be explicitly approved from your Inbox before they appear
        in your reports or overall balance.
      </DocsCallout>
