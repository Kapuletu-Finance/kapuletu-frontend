...
export default function GroupsIndexPage() {
  const guides = [
    ...
    {
      title: "Member profiles, Contribution history, and Pledges",
      link: "/docs/groups/member-profiles",
    },
  ...
  return (
    ...
    >
      <DocsCallout type="info">
        Groups are the foundational unit in KapuLetu. Every fundraising activity, contribution, and
        report belongs to a specific group.
      </DocsCallout>
