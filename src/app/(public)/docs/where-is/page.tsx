...
export default function WhereIsPage() {
  const references = [
    ...
    { action: "Record a manual contribution", location: "Contributions → Add Contribution", link: "/docs/contributions" },
    { action: "Review a pending M-Pesa message", location: "Contributions → Inbox", link: "/docs/contributions" },
    { action: "Create a new fundraising goal", location: "Fundraising → Create Activity", link: "/docs/fundraising" },
    ...
    { action: "Reconcile my M-Pesa balance", location: "Reconciliation", link: "/docs/reconciliation" },
    { action: "Change my password", location: "Settings → Security", link: "/docs/security" },
    { action: "Turn on WhatsApp forwarding", location: "Settings → WhatsApp", link: "/docs/whatsapp" },
  ];
  ...
  return (
    ...
    >
      ...
      <DocsCallout type="info" title="Need more details?">
        Click on any of the locations above to read the full step-by-step guide on how to complete the action.
      </DocsCallout>
