  ...
  const reportSteps = [
    {
      ...
      description: "Select the Reports module from the main sidebar.",
    },
    {
      title: "Select Report Type",
      description: "Choose the type of report you want to generate (e.g., Daily Summary).",
    },
    {
      title: "Set Date Range",
      description: "Use the calendar picker to select your desired date range.",
    },
    {
      title: "Generate & Export",
      description: "Click Generate, then choose whether to download as PDF or share directly.",
    },
  ];
  ...
  return (
    ...
    >
      <DocsCallout type="tip" title="Automatic Formatting">
        KapuLetu automatically formats reports to look great on both A4 PDFs and standard WhatsApp
        messages.
      </DocsCallout>
