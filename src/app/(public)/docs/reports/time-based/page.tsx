...
export default function TimeBasedReportsPage() {
  const steps = [
    { title: "Open Reports", description: "Navigate to the 'Reports & Analytics' tab." },
    {
      ...
      description: "Choose 'Daily', 'Weekly', or 'Monthly' Treasury Report from the templates.",
    },
    {
      title: "Set the Date Range",
      description: "Select the specific day, week, or month you want to generate the report for.",
    },
    {
  ...
  return (
    ...
    >
      <p>
        Time-based reports give you a snapshot of all financial activity within a specific window.
        These are perfect for presenting at group meetings or sharing in your WhatsApp group at the
        end of the week.
      </p>
      ...
      <DocsCallout type="important" title="Unapproved Contributions">
        Reports ONLY calculate contributions that have been explicitly Approved from your Inbox.
        Pending contributions will not appear in the final report!
      </DocsCallout>
    </DocsArticle>
  );
}
