...
export default function FundraisingIndexPage() {
  const guides = [
    {
      title: "Understanding fundraising activities",
      link: "/docs/fundraising/understanding-activities",
    },
    {
      title: "Creating an activity & Setting a target",
      link: "/docs/fundraising/creating-activity",
    },
    ...
    {
      title: "Managing an activity & Viewing activity progress",
      link: "/docs/fundraising/managing-activity",
    },
    { title: "Editing activity details", link: "/docs/fundraising/editing-details" },
    {
      title: "Assigning, Reassigning, and Splitting contributions",
      link: "/docs/fundraising/assigning-contributions",
    },
    {
      title: "Viewing activity statistics & Closing an activity",
      link: "/docs/fundraising/activity-statistics",
    },
  ...
  return (
    ...
    >
      <DocsCallout type="info" title="What is an Activity?">
        ...
        collected. For example: "December Welfare", "Jane's Wedding", or "Monthly Contributions".
      </DocsCallout>
