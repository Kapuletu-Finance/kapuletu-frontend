...
export default function SecurityIndexPage() {
  const accountGuides = [
    {
      title: "Creating an account, Signing in, Verifying email",
      link: "/docs/security/account-creation",
    },
    {
      title: "Changing/Resetting password, Updating profile",
      link: "/docs/security/password-profile",
    },
    {
      title: "Managing phone number, Managing sessions, Logging out",
      link: "/docs/security/sessions",
    },
  ];
  ...
  return (
    ...
    >
      <DocsCallout type="info" title="Security First">
        Because KapuLetu handles financial data, we strongly recommend enabling Two-Factor
        Authentication (2FA) for all Treasurer accounts.
      </DocsCallout>
