...
export default function WhatsAppIndexPage() {
  ...
  const troubleshootingGuides = [
    {
      title: "Handling unknown contributors & masked numbers",
      link: "/docs/whatsapp/masked-numbers",
    },
    { title: "Handling duplicate messages", link: "/docs/whatsapp/duplicate-messages" },
    {
      title: "Handling incorrect amounts or wrong activities",
      link: "/docs/whatsapp/incorrect-amounts",
    },
  ...
  return (
    ...
    >
      <DocsCallout type="info" title="The most powerful feature">
        WhatsApp integration is what makes KapuLetu special. Instead of manually typing out hundreds
        of M-Pesa receipts, you can simply forward them to the KapuLetu bot, and they will be
        automatically parsed into your Inbox.
      </DocsCallout>
